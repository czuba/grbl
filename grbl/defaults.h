...
#define DEFAULT_X_ACCELERATION (10.0*60*60) // e.g., 10*60*60 mm/min^2 = 10 mm/sec^2
#define DEFAULT_Y_ACCELERATION (10.0*60*60)
#define DEFAULT_Z_ACCELERATION (10.0*60*60)
#define DEFAULT_X_MAX_TRAVEL 900.0 // mm
#define DEFAULT_Y_MAX_TRAVEL 900.0 // mm
#define DEFAULT_Z_MAX_TRAVEL 900.0 // mm
#define DEFAULT_SPINDLE_RPM_MAX 11000.0 // rpm
